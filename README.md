...
2 CPU / 4096 MB RAM / 50 GB Storage
...
Administrator@corp.lab-x-dc.com



Primary Domain Controller, DNS, DHCP
...
3 CPU / 4096 MB RAM / 80 GB Storage
...
johnd@corp.lab-x-dc.com



Domain-joined workstation (John Doe)
...
1 CPU / 2048 MB RAM / 50 GB Storage
...
Domain-joined Linux client (Jane Doe) + Mail Watcher
...
1 CPU / 2048 MB RAM / 25 GB Storage
...
lab-x-admin@corp-svr



Corporate Application Server (Docker + MailHog)
...
Ubuntu Desktop Client (linux-client / Jane Doe):
...
Ubuntu Corporate Server (corp-svr / lab-x-admin):
